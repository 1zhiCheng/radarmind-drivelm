#!/usr/bin/env python3
"""Precompute chosen/rejected log probabilities under a frozen reference adapter."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--reference-policy-label", default="v0.37B checkpoint-75")
...
def main() -> None:
    ...
    with output.open(mode, encoding="utf-8") as handle:
        for row in shard_rows:
            ...
            enriched = {
                **row,
                "reference_policy": args.reference_policy_label,
    ...
    report = {
        "schema_version": "drivelm-v038-reference-logp-v1",
        "reference_policy": args.reference_policy_label,
