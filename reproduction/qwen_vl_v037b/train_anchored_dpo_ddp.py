#!/usr/bin/env python3
"""Task-balanced CE-anchored three-GPU DPO initialized from frozen B10."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--experiment-name", default="v037b-b10-anchored-dpo")
...
def main() -> None:
    ...
    if args.resume_from:
        state_path = Path(args.resume_from) / "v037b_training_state.pt"
    ...
    metadata = {
        "objective": "DPO plus chosen-answer CE anchor with frozen-B10 reference log-probabilities",
